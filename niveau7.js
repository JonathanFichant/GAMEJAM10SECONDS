...
class niveau7 extends Phaser.Scene {
    ...
    create() { // Création des éléments dès l'initialisation du jeu
        ...
        this.map1 = this.add.tilemap('lvl7');
        ...
        this.affichageCountdown = this.add.text(500, 300, this.countdown / 1000 + ' s', { fontFamily: 'Arial', fontSize: 256, color: '#ff0000' });


        // PLAYER
        this.spawnPlayerX = 32 * 23.5;
        this.spawnPlayerY = 32 * 25.5;
        ...
        //32 * 45, 8 * 32
        this.flag = this.physics.add.sprite(32 * 24.5, 8 * 32, 'flag');
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.keyEscape)) {
            ...
            //this.player.destroy();
            this.scene.start('menuSkill', { entrance: 'niveau7'/*, DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX*/, savePA: this.savePA  });
        }
    ...
    hitFlag() {
        if (!this.flagHit) {
            ...
            this.scene.start('sceneFin')//, { entrance: 'niveau7', DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX, PA: this.PA, savePA:this.savePA, levelComplete:this.levelComplete, currentLevel: this.currentLevel });
        }
