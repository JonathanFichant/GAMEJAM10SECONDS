...
class niveau1 extends Phaser.Scene {
    ...
    create() { // Création des éléments dès l'initialisation du jeu
        ...
        //32 * 45, 8 * 32
        this.flag = this.physics.add.sprite(32 * 43.5, 4.5 * 32, 'flag');
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.keyEscape)) {
            ...
            //this.player.destroy();
            this.scene.start('menuSkill', { entrance: 'niveau1'/*, DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX, PA: this.PA */ });
        }
    ...
    hitFlag() {
        if (!this.flagHit) {
            ...
            this.scene.start('menuSkill', { entrance: 'niveau1', DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX, PA: this.PA, savePA:this.savePA, levelComplete:this.levelComplete, currentLevel: this.currentLevel });
        }
