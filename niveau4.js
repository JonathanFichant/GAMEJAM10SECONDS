...
class niveau4 extends Phaser.Scene {
    ...
    create() { // Création des éléments dès l'initialisation du jeu
        ...
        this.map1 = this.add.tilemap('lvl4');
        ...
        //32 * 45, 8 * 32
        this.flag = this.physics.add.sprite(32 * 37.5, 17 * 32, 'flag');
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.keyEscape)) {
            ...
            //this.player.destroy();
            this.scene.start('menuSkill', { entrance: 'niveau4'/*, DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX*/, savePA: this.savePA  });
        }
    ...
    hitFlag() {
        if (!this.flagHit) {
            ...
            this.scene.start('menuSkill', { entrance: 'niveau4', DOUBLEJUMP: this.DOUBLEJUMP, WALLJUMP: this.WALLJUMP, DASH: this.DASH, SLIME: this.SLIME, INTANGIBLE: this.INTANGIBLE, FAKIR: this.FAKIR, SHIELD: this.SHIELD, MATRIX: this.MATRIX, PA: this.PA, savePA:this.savePA, levelComplete:this.levelComplete, currentLevel: this.currentLevel });
        }
